/* 
    Question: Top skills based on salary?
...
/*
    -High demand for Big Data & ML skills: Top salaries are commanded by analysts skilled in big data 
     technologies(PySpark, Couchbase), machine learning tools (DataRobot, Jupyter) and Python libraries
     (Pandas, NumPy).
     - Software Development & Deployment Proficiency: Knowledge in tools like GitLab, Kubernetes, Airflow)
